...
def wait_and_open_browser():
    """
    서버의 특정 포트가 열릴 때까지 대기한 후, 자동으로 웹 브라우저를 열어 해당 URL로 접속합니다.
    """
...
if __name__ == "__main__":
    # 스크립트 실행 위치를 현재 파일이 위치한 디렉토리로 변경
